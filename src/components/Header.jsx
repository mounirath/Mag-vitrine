  ...
  return (
    <div>
      ...
      <header className="navy-top-header">
        ...
        <div className="quick-pills-row" style={{ position: 'relative' }} ref={dropdownRef}>
          {/* خانة الدخول الرئيسية - Interactive Login & Registration Box */}
          <button
        ...
        {/* Auth Popup Menu: دخول المستخدم و إنشاء حساب + دخول تاجر و إنشاء حساب */}
        {isAuthDropdownOpen && (
          <div
            style={{
              position: 'absolute',
              ...
              color: 'var(--text-main)',
              left: isAr ? 'auto' : '1.2rem',
              right: isAr ? '1.2rem' : 'auto',
              ...
              <div>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0.75rem', marginBottom: '0.75rem' }}>
                  ...
                  >
                    ...
                    >
                      <LogIn size={13} />
                      <span>{isAr ? 'دخول المستخدم' : 'Connexion'}</span>
                    </button>
                  ...
                  >
                    ...
                    >
                      <Store size={13} />
                      <span>{isAr ? 'إنشاء حساب تاجر' : 'Ouvrir Vitrine'}</span>
                    </button>
                  </div>
                </div>
